        ...
        <div align="center">
            <asp:GridView ID="gvproduct" runat="server" Width="574px" CaptionAlign="Top"
                ...
                <EmptyDataRowStyle BackColor="#eeeeee" BorderColor="Black"
                    BorderStyle="Solid" BorderWidth="1px" Font-Size="Large" ForeColor="#2D2F21"
                    HorizontalAlign="Center" />
                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                <HeaderStyle BackColor="#2D2F21" Font-Bold="True" ForeColor="White" />
                <PagerStyle BackColor="#2D2F21" ForeColor="Black" HorizontalAlign="Center" />
