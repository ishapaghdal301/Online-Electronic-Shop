...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <div class="loginContainer">
            <div class="sideLogin">
                <p class="welcome" style="margin-left:-10%;">Welcome to Electro mart</p>
                <table style="margin: 0 auto;">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:Button ID="lnkRegister" runat="server" CssClass="button" Text="New Registration" PostBackUrl="~/Registration.aspx" CausesValidation="False" />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
